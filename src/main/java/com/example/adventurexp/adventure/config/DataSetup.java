...
public class DataSetup implements ApplicationRunner {
        ...
        public void run(ApplicationArguments args) throws Exception {
                ...
                Employee employee = new Employee("Admin", "Admin", "Admin", "Admin", "admin", "admin", "Admin");
        ...
        public static List<Shift> generateShifts(int numberOfShifts, List<Employee> employees, List<Activity> activities) {
                ...
                for (int i = 0; i < numberOfShifts; i++) {
                        ...
                        Activity activity = activities.get(random.nextInt(activities.size()));
                        Shift shift = new Shift(employee, activity, shiftStart, shiftEnd);
                        shifts.add(shift);
                }
